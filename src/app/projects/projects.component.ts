...
openlink(link,project){
  ...
  projects:Project[] = [
    ...
    {id:0,title:'Music-Hub',link:'https://music-hub-app.herokuapp.com/',desc:'Web application that gives you access to playlists of different artists',date:'25/05/2020'},
    ...
    {id:0,title:'Karibu Kenya',link:'https://karibukenya.herokuapp.com/',desc:'Web Application that informs potential tourists alot about Kenya before visisting ',date:'25/05/2020'},
